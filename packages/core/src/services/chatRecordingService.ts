...
export class ChatRecordingService {
  ...
  private restoreSessionState(
    ...
    // Presence, not truthiness: an empty-string title is the clear-tombstone
    // and must re-anchor exactly like a named title.
   ...
   * to EOF once its threshold is reached. "Active" is presence-based for the
   * title: an empty-string title is the clear-tombstone and must stay anchored
   * exactly like a named title, otherwise the windowed reader loses it and
   * resurrects the pre-clear name.
   *
